 ...
 */
public class AlwaysOffEvaluationStrategy extends AbstractEvaluationStrategyForFMU {
	 ...
	 */
	public AlwaysOffEvaluationStrategy(OptionModelController optionModelController) {
	...
	public void runEvaluation() {
		...
		while (tsse.getGlobalTime() < this.getEndTime() ) {
			...
			for (int i=0; i<deltaSteps.size(); i++) {
				...
				if (heatPumpSetpoint.isValue()==false && coilSetpoint.isValue()==false) {
					decisionIndex = i;
					break;
				}
			}
